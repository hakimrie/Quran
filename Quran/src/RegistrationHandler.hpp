...
class RegistrationHandler: public QObject {
	...
	// flag indicating whether the application is successfully registered with bbm
	...
	// flag indicating whether registration failed due to a temporary error. this allows the user to re-try
	// registration
