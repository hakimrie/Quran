...
Container {
    ...
    property double ayahFontSize// : ayahArabic.textStyle.fontSizeValue
    property alias translationText: translation.text
    property double translationFontSize //: translation.textStyle.fontSizeValue
    property string bookmarked
    property string surah
    property bool displayAyat
    property bool displayTranslation
    //property alias ayatFontSize : ayahArabic.textStyle.fontSize
            ...
            Container { // nomor ayat
                ...
                Label {
                    ...
                    textStyle {
                        ...
                        fontWeight: FontWeight.Bold
                        fontSize: FontSize.Default
                        color : bookmarked == 'true' ? Color.White : Color.Black
                    }
                }
                rightMargin: 12
            }
        ...
        Container { // ayat dan terjemahnya
            ...
            Label {// text arab ayat
                ...
                textStyle {
                    ...
                    fontFamily: "Arial"
                    fontSizeValue : ayahFontSize
                }
                multiline: true
                visible: displayAyat;
            }
            Label { // text terjemah latin
                id: translation
                horizontalAlignment: HorizontalAlignment.Left
                verticalAlignment: displayAyat ? VerticalAlignment.Bottom : VerticalAlignment.Top;
                multiline: true
                
                textStyle{
                    fontSize: FontSize.PointValue
                    fontSizeValue : translationFontSize
                }
                text: "Dengan Menyebut Nama Allah Yang Maha Pengasih lagi Maha Penyayang" 
                visible: displayTranslation;
            }
...
//        		<juz index="30" surahName="An-Naba'" sura="78" aya="1" />
        ...
        (surat == '5' && ayat == '82') || (surat == '6' && ayat == '111') || (surat == '7' && ayat == '88') || 
        (surat == '8' && ayat == '41') || (surat == '9' && ayat == '93') || (surat == '11' && ayat == '6') || 
